...
set rc [catch {
  ...
  set_property ip_repo_paths c:/Users/Marco/VGA-Interface/VGA-Interface.cache/ip [current_project]
  set_property ip_output_repo c:/Users/Marco/VGA-Interface/VGA-Interface.cache/ip [current_project]
  add_files -quiet C:/Users/Marco/VGA-Interface/VGA-Interface.runs/synth_1/Top_Wrapper.dcp
